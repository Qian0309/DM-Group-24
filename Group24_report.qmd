...
## Task 1.1: Entity-Relationship (E-R) Diagram Design and Relationship Sets
...
![](Figures\Screenshots\ERD\ERD_before_normalization.png)

The E-R diagram after normalizing our schema up to at least 3NF is shown below.

![](Figures\Screenshots\ERD\ERD_after_normalization.png)
...
Represents a one-to-many relationship, showing that each product can have multiple reviews written about it, Conversely, xeach review is associated with one product, indicating that customers’ feedback is specific to a particular product
...
Translating the E-R diagram into a functional SQL database schema, defining tables with appropriate data types, constraints, primary and foreign keys. keys.
