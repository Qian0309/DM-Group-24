...
For the purpose of validating multiple ingestions, four splits of data are generated. There are entries of bad data in the last two splits to check the validation tests.
